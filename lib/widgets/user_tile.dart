      ...
      Container(
        ...
        child: Container(
          ...
          child: Row(children: [
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      _showBottomSheet(context,user!,Colors.redAccent);
                    },
                    child: Text(
                      "description",
                      style: GoogleFonts.lato(
            ...
            Text(user!.category.toString(),style: TextStyle(decoration: TextDecoration.underline,color: Get.isDarkMode? Colors.black:Colors.grey[100]),),
            SizedBox(width: 40,),
